:title: WMO WIS2 Notification Message Encoding
:titletext: {title}
:version: 1.2.0
:date: {docdate}
...
|Date: {docdate} (HTML, PDF and Word generation)
|Version: {version}
|Document status: STABLE
|Document location: https://wmo-im.github.io/wis2-notification-message/standard/wis2-notification-message-STABLE.html
